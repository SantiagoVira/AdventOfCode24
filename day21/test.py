...
'''
Correct:    <vA <A A >>^A vA <^A >A A A vA ^A v<<A>A^>AvA^A<A>Av<<A>>^AvA^Av<<A>A^>AAA<Av>A^A
Mine:       <vA <A A >>^A vA <^A >A A A vA ^A <vA>^Av<<A>>^AvA<^A>Av<<A>>^AvA^Av<<A>A>^AAAvA<^A>A


Correct:    v<<A>^AAA>A<vA>A^A<A>A<vAAA^>A
Mine:       v<<A>^AAA>AvA<A>^A<A>A<vAAA>^A
